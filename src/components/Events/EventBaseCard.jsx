...
import { Trophy, ChevronRight, Calendar, Locate, Map, Lock } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div className="p-6 space-y-4">
        ...
        {level.is_active == 0 ? (
          <div className="w-full bg-red-500 text-white py-3 px-6 rounded-xl font-semibold flex items-center justify-center gap-2 cursor-not-allowed">
            <Lock className="w-5 h-5" />
            <span className="text-sm">Registration Locked</span>
          </div>
        ) : (
          <motion.button
