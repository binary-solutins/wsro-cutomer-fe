        ...
        <div className="text-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-indigo-100/90 max-w-2xl mx-auto leading-relaxed">
              Have questions about our robotics programs? Our team of experts is ready to assist you with competition inquiries, technical support, or collaboration opportunities.
            </p>
