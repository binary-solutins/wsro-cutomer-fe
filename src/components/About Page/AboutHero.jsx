      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-28">
        <div className="text-center">
          ...
          >
            ...
            Discover the future of innovation! Join us in a thrilling journey where creativity meets technology. Be part of an exciting robotics competition designed to challenge and inspire the next generation of tech enthusiasts.
            </p>
