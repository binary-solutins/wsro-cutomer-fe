...
function Points() {
  const features = [
    ...
    {
      icon: Award,
      title: "Own Manufacturing means Lowest possible cost and Original",
    },
    {
      icon: Wrench,
      title: "IN – House Research and Development dedicated Team of engineers",
    },
    {
      icon: Globe2,
      title: "Dealing in all over India, Middle East and Africa",
    },
    {
      icon: Users,
      title:
    ...
    {
      icon: GraduationCap,
      title: "Leadership and Innovation based activities for school students",
    },
    {
      icon: Trophy,
      title:
    ...
    <div className="min-h-screen bg-[#1a1a1a] text-white">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-16 text-center">
          <button onClick={() => window.location = '/competitions'} className="bg-[#f46572] hover:bg-[#e55561] text-white font-bold py-4 px-8 rounded-full shadow-lg transform transition-all duration-300 hover:scale-105">
            Register Now
          </button>
