      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-28">
        <div className="text-center">
          ...
          >
            ...
            Relive the moments of innovation and excitement! Explore our gallery to witness the creativity, teamwork, and technological brilliance that define our robotics competition.
            </p>
