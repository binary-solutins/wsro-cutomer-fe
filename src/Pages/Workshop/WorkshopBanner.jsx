      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-28">
        <div className="text-center">
          ...
          >
            ...
            Empower your skills and expand your horizons! Our workshops offer hands-on learning experiences designed to ignite your passion for robotics and technology. Join us to explore, innovate, and excel.
            </p>
