      ...
      <div className="relative max-w-7xl mx-auto px-4 py-20 md:py-28">
        <div className="text-center">
          ...
          >
            ...
            Partner with us to shape the future of innovation! Showcase your brand to a community of tech enthusiasts and pioneers by supporting our robotics competition. Together, let's inspire the next generation of creators.
            </p>
