...
import ImageOverlay from '../../components/Events/ImageOverLay';
import FloatingElements from '../../components/Events/FloatingElements';


const SponsorPageImage = ({img}) => {
  return (
...
export default SponsorPageImage;